...
- リンク
  - [x] [アルゴリズムとデータ構造](https://www.codereading.com/algo_and_ds/)
  - [x] [非公式PDF版SICP・新訳 - アスペ日記](https://takeda25.hatenablog.jp/entry/20151030/1446174031)
  - [x] [アルゴリズムの世界地図 - Qiita](https://qiita.com/square1001/items/6d414167ca95c97bd8b2)
  - [x] [AtCoder での実力アップを目指そう！　競プロ典型 90 問 - Qiita](https://qiita.com/e869120/items/1b2a5f0f07fd927e44e9)
  - [x] [プログラマの採用面接で聞かれる、データ構造とアルゴリズムに関する50以上の質問 | POSTD](https://postd.cc/50-data-structure-and-algorithms-interview-questions-for-programmers/)
...
- リンク
  ...
  - [x] [TypeScript、上達の瞬間 - Speaker Deck](https://speakerdeck.com/sadnessojisan/typescript-shang-da-noshun-jian)
  - [x] [フロントエンドのデザインパターン](https://zenn.dev/morinokami/books/learning-patterns-1)
...
- リンク
  ...
  - [x] [無から始める自作CPU](https://vlsi.jp/LetsMakeCPU.html)
  - [x] [Welcome to Linux From Scratch!](https://www.linuxfromscratch.org/index.html)
  - [x] [ZigでWriting an OS in 1,000 Linesをやる | MaybeUnInit](https://bokuweb.github.io/undefined/articles/20231121.html)
...
- リンク
  ...
  - [x] [北米ソフトウェアエンジニアのインタビュー選考ってこんな感じだよ｜Yanmer](https://note.com/yanmerrr/n/n69d77772e255)
...
- リンク
  ...
  - [ ] [正規表現のパーサー - 作って学ぶ正規表現エンジン](https://makenowjust.github.io/kantan-regex-book/3-parser.html)
  - [ ] [正規表現オンライン教材](http://www2.otani.ac.jp/fkdsemi/seikihyogen/mondai.html)
  ...
  - [x] [SLI/SLO 完全ガイド - CyberAgent SRG #ca_srg](https://ca-srg.dev/32f7b8c96de7489094802512de434d0f)
